    ...
    def create_optimizer(self):
        ...
        if self.optimizer is None:
            ...
            if self.args.visual_abstractor_lr is not None:
                ...
                L_parameters = [name for name, _ in opt_model.named_parameters() if "learned_weight" in name]
                optimizer_grouped_parameters = [
                    {
                        "params": [
                            p for n, p in opt_model.named_parameters() if (n in decay_parameters and n not in projector_parameters and n not in L_parameters and p.requires_grad)
                        ],
                    ...
                    {
                        "params": [
                            p for n, p in opt_model.named_parameters() if (n in decay_parameters and n in projector_parameters and n not in L_parameters and p.requires_grad)
                        ],
                        "weight_decay": self.args.weight_decay,
                    ...
                    {
                        "params": [
                            p for n, p in opt_model.named_parameters() if (n not in decay_parameters and n in projector_parameters and n not in L_parameters and p.requires_grad)
                        ],
                        "weight_decay": 0.0,
                        "lr": self.args.visual_abstractor_lr,
